...
authorwatch_create.pl [options] model|view|controller name [helper] [options]
 ...
 Examples:
   ...
   authorwatch_create.pl model SomeDB DBIC::SchemaLoader dbi:SQLite:/tmp/my.db
   authorwatch_create.pl model AnotherDB DBIC::SchemaLoader dbi:Pg:dbname=foo root 4321
