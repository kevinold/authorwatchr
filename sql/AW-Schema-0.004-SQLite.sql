...
-- Created on Fri May 15 16:15:21 2009
-- 
...
-- Table: genre_authors
--
DROP TABLE genre_authors;

CREATE TABLE genre_authors (
  genre_id integer(128) NOT NULL,
  author_id varchar(128) NOT NULL,
  PRIMARY KEY (genre_id, author_id)
);

CREATE INDEX genre_authors_idx_author_id_ge ON genre_authors (author_id);

CREATE INDEX genre_authors_idx_genre_id_gen ON genre_authors (genre_id);
